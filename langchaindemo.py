...
prompt = PromptTemplate(
    ...
    is relevant to the 'Human Input' query or prompt. 
    ...
    scenario, especially the tags enclosed in single quotation marks '' by which the content is navigated, 
    however, you are free to mold the amound of steps, decision points, quiz questions, choices etc., 
    to the suitability and scale of the information about which human is inquiring you about. 
    Stick to the format and tags of the specific 
    ...
    scenarios.
    'Human Input': {human_input},{subject_name},Information relevant to human input:({input_documents}).Remember the information
    ...
    \n\nIMPORTANT NOTE\n\n The 'Chat History' variable is one that if user inquires of something
    in the previous conversations, especially questions related to past conversations 
    and seeks to amend, add or remove anything from past conversation scnearios, then
    help user in this regard. If user wants to amend, add or remove something in the past
    conversation, then using the exact same format of the scenario that user inquired, give
    your response in that same very format. But if user freely wants to inquire about
    anything else, then you are also free to engage with the user to support user's queries.
